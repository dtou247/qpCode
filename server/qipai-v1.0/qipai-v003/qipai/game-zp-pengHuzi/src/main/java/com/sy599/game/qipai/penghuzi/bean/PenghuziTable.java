...
//						}
    ...
    public void initExtend0(JsonWrapper wrapper) {
        ...
        _5FuBuFanBei= wrapper.getInt(37, 0);
    }
...
//    	}
    	...
    	if(zhuangCount>0){
    		if(lianz==2){
    		   if(_5FuBuFanBei==1 && dahu==PengHZMingTang.WU_FU){
                    totalPoint+=40;
                }else{
...
//		JsonWrapper wrapper = new JsonWrapper("");
        ...
        wrapper.putInt(37, _5FuBuFanBei);
    ...
    public boolean createTable(CreateTableInfo createTableInfo) throws Exception {
     ...
     // List<String> strParams = createTableInfo.getStrParams();
      boolean saveDb = createTableInfo.isSaveDb();
         ...
         this._5FuBuFanBei =  StringUtil.getIntValue(params, 21, 0);
