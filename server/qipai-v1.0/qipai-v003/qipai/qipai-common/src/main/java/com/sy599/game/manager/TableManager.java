                ...
                if (bt != null) {
                    ...
                    if (gu != null) {
                        ...
                        if (bt.getCreditMode() == 1 && gu.getCredit() < bt.getCreditJoinLimit()) {
                            player.writeErrMsg(LangMsg.code_64, MathUtil.formatCredit(bt.getCreditJoinLimit()), MathUtil.formatCredit(gu.getCredit()));
                            return null;
                        }
...
//        player = PlayerManager.getInstance().changePlayer(player, table.getPlayerClass());
    ...
    public static Map<Long, BaseTable> getTableMap() {
        return tableMap;
    }
}
