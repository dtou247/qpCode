package com.sy599.game.qipai.yzphz.webservice;
        ...
        try {
            ...
            if (isDigits(tableIdStr)) {
                ...
                if (table == null) {
                    ...
                    if (table instanceof YzPhzTable) {
                        YzPhzTable table1 = (YzPhzTable) table;
                        ...
                        if (ucs.length == 1 && isDigits(ucs[0])) {
                            ...
                            synchronized (table1) {
                                ...
                                for (Integer temp : table1.getLeftCards()) {
                                    if (val == YzPhzCardUtils.loadCardVal(temp)) {
                                        card = temp;
                                        break;
                                    }
                                }
                            ...
                            synchronized (table1) {
                                if (table1.getMoCount() == 0 && table1.getDisCount() == 0) {
                                    ...
                                    if (list.get(0).intValue() > 0) {
                                        ...
                                        if (list.size() == 1) {
                                            YzPhzPlayer player1 = table1.getPlayer(user1, YzPhzPlayer.class);
                                            if (player1 != null && (player1.getHandCards().SRC.size() == map.get(user1).size())
                                                ...
                                                if (card1.size() == map.get(user1).size()) {
                                                    List<Integer> allList = YzPhzCardUtils.loadCards(table1.getWangbaCount() > 0 ? table1.getWangbaCount() : 0);
                                                    if (allList.containsAll(map.get(user1))) {
                                                        ...
                                                        YzPhzPlayer player2 = (YzPhzPlayer) table1.getSeatMap().get(seat);
                                                        seat = table1.calcNextSeat(seat);
                                                        YzPhzPlayer player3;
                                                        if (is2) {
                                                            player3 = null;
                                                        } else {
                                                            player3 = (YzPhzPlayer) table1.getSeatMap().get(seat);
                                                        }
                                            ...
                                            YzPhzPlayer player1 = table1.getPlayer(user1, YzPhzPlayer.class);
                                            YzPhzPlayer player2 = table1.getPlayer(user2, YzPhzPlayer.class);
                                            if (player1 != null && (player1.getHandCards().SRC.size() == map.get(user1).size())
                                            ...
                                            if (user1 < user2 && user2 < user3) {
                                                YzPhzPlayer player1 = table1.getPlayer(user1, YzPhzPlayer.class);
                                                YzPhzPlayer player2 = table1.getPlayer(user2, YzPhzPlayer.class);
                                                YzPhzPlayer player3 = table1.getPlayer(user3, YzPhzPlayer.class);
                                                if (player1 != null && (player1.getHandCards().SRC.size() == map.get(user1).size())
                                                        && player2 != null && (player2.getHandCards().SRC.size() == map.get(user2).size())
