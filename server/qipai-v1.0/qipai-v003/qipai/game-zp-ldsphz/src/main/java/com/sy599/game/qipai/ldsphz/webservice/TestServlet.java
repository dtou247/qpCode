package com.sy599.game.qipai.ldsphz.webservice;
        ...
        try {
            ...
            if (isDigits(tableIdStr)) {
                ...
                if (table == null) {
                    ...
                    if (table instanceof LdsPhzTable) {
                        LdsPhzTable table1 = (LdsPhzTable) table;
                        ...
                        if (ucs.length == 1 && isDigits(ucs[0])) {
                            ...
                            synchronized (table1) {
                                ...
                                for (Integer temp : table1.getLeftCards()) {
                                    if (val == LdsPhzCardUtils.loadCardVal(temp)) {
                                        card = temp;
                                        break;
                                    }
                                }
                            ...
                            synchronized (table1) {
                                if (table1.getMoCount() == 0 && table1.getDisCount() == 0) {
                                    ...
                                    if (list.get(0).intValue() > 0) {
                                        ...
                                        if (list.size() == 1) {
                                            LdsPhzPlayer player1 = table1.getPlayer(user1, LdsPhzPlayer.class);
                                            if (player1 != null && (player1.getHandCards().SRC.size() == map.get(user1).size())
                                                ...
                                                if (card1.size() == map.get(user1).size()) {
                                                    List<Integer> allList = LdsPhzCardUtils.loadCards(table1.getWangbaCount() > 0 ? table1.getWangbaCount() : 0);
                                                    if (allList.containsAll(map.get(user1))) {
                                                        ...
                                                        LdsPhzPlayer player2 = (LdsPhzPlayer) table1.getSeatMap().get(seat);
                                                        seat = table1.calcNextSeat(seat);
                                                        LdsPhzPlayer player3;
                                                        if (is2) {
                                                            player3 = null;
                                                        } else {
                                                            player3 = (LdsPhzPlayer) table1.getSeatMap().get(seat);
                                                        }
                                            ...
                                            LdsPhzPlayer player1 = table1.getPlayer(user1, LdsPhzPlayer.class);
                                            LdsPhzPlayer player2 = table1.getPlayer(user2, LdsPhzPlayer.class);
                                            if (player1 != null && (player1.getHandCards().SRC.size() == map.get(user1).size())
                                            ...
                                            if (user1 < user2 && user2 < user3) {
                                                LdsPhzPlayer player1 = table1.getPlayer(user1, LdsPhzPlayer.class);
                                                LdsPhzPlayer player2 = table1.getPlayer(user2, LdsPhzPlayer.class);
                                                LdsPhzPlayer player3 = table1.getPlayer(user3, LdsPhzPlayer.class);
                                                if (player1 != null && (player1.getHandCards().SRC.size() == map.get(user1).size())
                                                        && player2 != null && (player2.getHandCards().SRC.size() == map.get(user2).size())
