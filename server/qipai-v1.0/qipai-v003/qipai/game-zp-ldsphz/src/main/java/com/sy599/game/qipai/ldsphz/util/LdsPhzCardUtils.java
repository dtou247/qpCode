...
public final class LdsPhzCardUtils {
	...
	public static List<List<Integer>> chongFa( List<List<Integer>> list,List<Integer> copy){
		...
		if(hasWang){//出现王重发
			list = LdsPhzCardUtils.fapaiControl(copy, 2, 14, 0);
		}
...
//				if(l.contains(81) && l.contains(82)){
//					shuangWangNum++;
//				}else if(l.contains(81)||l.contains(82)){
//					danWang++;
//				}
//			}
//		}
