...
public class GroupDaoNew extends CommonDaoImpl {
    ...
    public Long sumCreditLogList(long groupId, long userId, int type, String startDate, String endDate, int upOrDown,boolean isLookXipai) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("groupId", groupId);
        map.put("userId", userId);
        if (type > 0) {
    ...
    public int countCreditLogList(long groupId, long userId, int type, String startDate, String endDate, int upOrDown,boolean isLookXipai) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("groupId", groupId);
        map.put("userId", userId);
        if (type > 0) {
    ...
    public List<Map<String, Object>> creditLogList(long groupId, long userId, int type, String startDate, String endDate, int upOrDown, int pageNo, int pageSize,boolean isLookXipai) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("groupId", groupId);
        map.put("userId", userId);
        if (type > 0) {
